 ...
 * 
 * @url https://core.telegram.org/bots/api#getwebhookinfo -> \Tg\Core\Webhook->info
 * @url https://core.telegram.org/bots/api#setwebhook     -> \Tg\Core\Webhook->set
 * @url https://core.telegram.org/bots/api#deletewebhook  -> \Tg\Core\Webhook->delete
 */
...
class Bot {
  ...
  public function sendMessage( array $Params ): array {
    return \Tg\Connect::instance()->post( 'sendMessage', $Params );
  }
  ...
  public function deleteMessage( array $Params ): array {
    return \Tg\Connect::instance()->post( 'deleteMessage', $Params );
  }
  ...
  public function editMessageText( array $Params ): array {
    return \Tg\Connect::instance()->post( 'editMessageText', $Params );
  }
  ...
  public function editMessageReplyMarkup( array $Params ): array {
    unset( $Params['text']);
    return \Tg\Connect::instance()->post( 'editMessageReplymarkup', $Params );
  }
   ...
   * 
   * @param array $Params
   * - offset           Integer           Optional  Identifier of the first update to be returned. Must be greater by one than the highest among the identifiers of previously received updates. 
  ...
  public function getUpdates( array $Params=null): array {
    $Response = \Tg\Connect::instance()->post( 'getUpdates', [
